...
new_studio.save
# puts new_studio["name"]

# puts "Studios: #{Studio.all.count}"

#Filling out the Movie DB
...
new_actor = Actor.new
new_actor["name"] = "Maggie Gyllenhall"
new_actor.save
...
#Filling out the Role DB

# puts "Characters: #{Role.all.count}"
...
maggie = Actor.find_by({"name" => "Maggie Gyllenhall"})
...
batman = Actor.find_by({"name" => "Christian Bale"})

new_role = Role.new
new_role["character_name"] = "Bruce Wayne"
new_role["movie_id"] = knight_rises["id"]
new_role["actor_id"] = batman["id"]
new_role.save
